...
const Ibadah = lazy(() => import('./modules/Ibadah'));
const Iqra = lazy(() => import('./modules/Iqra'));
const Souq = lazy(() => import('./modules/Souq'));
const MediaStudio = lazy(() => import('./modules/MediaStudio'));
...
const AppContent: React.FC = () => {
  ...
  const handleNavigate = (view: NavView) => {
    switch (view) {
      ...
      case NavView.ADMIN: navigate('/admin'); break;
      default: navigate('/');
    }
  };
