...
import { generateDoaCard } from '../services/geminiService';
  ...
  return (
    <div className="p-4 space-y-6 pb-24 animate-fade-in relative">
        ...
        <div className="flex justify-between items-end">
            ...
            {!isEditing ? (
                 <button onClick={() => setIsEditing(true)} className="text-teal-pulse text-sm font-semibold hover:text-teal-400">Edit</button>
            ) : (
                 <div className="flex gap-4">
                     <button onClick={() => { setIsEditing(false); setName(user.name); }} className="text-slate-400 text-sm hover:text-white">Cancel</button>
                     <button onClick={handleSave} className="text-teal-400 text-sm font-bold hover:text-teal-300">Save</button>
                 </div>
            )}
        </div>
        ...
        {activeTab === 'PERSONAL' && (
            <div className="space-y-6 animate-slide-up">
                ...
                <div className="flex flex-col items-center py-8 bg-slate-900 relative overflow-hidden rounded-3xl border border-slate-800 shadow-lg">
                    ...
                    <div className="relative z-10 w-24 h-24 rounded-full bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(20,184,166,0.2)] ring-2 ring-teal-pulse/50">
                    ...
                    <div className="relative z-10 text-center w-full flex flex-col items-center">
                        {isEditing ? (
                            <input 
                                ...
                                className="bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-center text-white font-bold outline-none focus:border-teal-pulse w-2/3"
                ...
                <div className="space-y-2">
                    ...
                    <div className="bg-slate-900/50 rounded-2xl overflow-hidden border border-slate-800 backdrop-blur-sm">
                        <div className="p-4 flex justify-between items-center border-b border-slate-800/50 hover:bg-slate-800/50 transition-colors cursor-pointer">
                            ...
                            <div className="w-10 h-5 bg-teal-500/20 rounded-full relative">
                                <div className="w-3 h-3 bg-teal-500 rounded-full absolute right-1 top-1 shadow-sm"></div>
                            </div>
                        </div>
                        <div 
                            onClick={onSignOut}
        ...
        {activeTab === 'FAMILY' && (
            <div className="space-y-6 animate-slide-up">
                 <div className="bg-gradient-to-r from-purple-900 to-indigo-900 p-6 rounded-3xl text-center border border-white/5 relative overflow-hidden">
                     ...
                     <button className="px-6 py-2 bg-white text-purple-900 font-bold rounded-full text-sm hover:bg-slate-200 transition-colors relative z-10 shadow-lg">
                         Upgrade (RM 19.90/mo)
                     </button>
                 </div>
                     ...
                     <div className="space-y-3">
                         ...
                         <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                             <div className="flex items-center gap-4 mb-3">
                                 <div className="w-10 h-10 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center font-bold border border-blue-500/30 shadow-inner">
                                     A
                                 </div>
                         ...
                         <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors">
                            <div className="flex items-center gap-4 mb-3">
                                <div className="w-10 h-10 rounded-full bg-pink-500/20 text-pink-400 flex items-center justify-center font-bold border border-pink-500/30 shadow-inner">
                                    S
                                </div>
                                <div className="flex-1">
