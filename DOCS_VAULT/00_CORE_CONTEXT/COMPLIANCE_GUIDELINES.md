...
|:---|:---|:---|:---|
| **Prayer Times** | **E-Solat JAKIM** (`e-solat.gov.my`) | Aladhan API (configured to `JAKIM` method) | Generic calculation libraries without localization |
| **Zakat Rates** | **PPZ / LZS Official Rates** | - | Old/Outdated static values |
| **Hijri Date** | **JAKIM Falak Online** | - | Purely mathematical calculation (Moon sighting takes precedence) |

**Compliance Rule:** *"Prayer times must exactly match the official zone times where the user is located."*

### 4.3 Cluster C: Knowledge & Education (The "Mudarris" Layer)

| Data Point | Official Source (Mandatory) | Allowable Sandbox/Fallback | Prohibited Sources |
|:---|:---|:---|:---|
| **Hadith Verification** | **Dorar.net** / **Sunnah.com** | Verified Kutub al-Sittah digitized books | Unreferenced quotes, "Viral" forwarded messages |
| **Tafsir** | **Tafsir Ibn Kathir** (Verified Translation) | Tafsir Al-Jalalayn (Verified) | Personal opinions, Unqualified interpretations |

---

## 🎨 PART 5: UI/UX COMPLIANCE GUIDELINES

### 5.1 Quranic Text Display Rules
...
## 🔐 PART 6: DATA INTEGRITY & SECURITY

### 6.1 Text Verification System
