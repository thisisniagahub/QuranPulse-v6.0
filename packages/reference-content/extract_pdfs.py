"""
PDF text extractor for the QuranPulse reference-content package.
Extracts text from all PDFs in this package and writes Markdown outputs.
"""
...
def main():
    ...
    output_dir = content_dir / "extracted-text"
