...
const Community: React.FC = () => {
  return (
    <div className="min-h-screen bg-black pb-24">
      {/* Header */}
      <div className="relative h-48 bg-gradient-to-b from-teal-900/20 to-black overflow-hidden">
      ...
      <div className="px-4 -mt-6 relative z-10">
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-2">
            ...
            <div className="flex p-1 bg-slate-800/50 rounded-2xl mb-4">
                <button className="flex-1 py-2 rounded-xl bg-teal-600 text-white font-bold text-sm shadow-lg">Moments</button>
