...
import AnnouncementManager from './tools/AnnouncementManager';
                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar">
                    {NAV_ITEMS.map((item) => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all group ${activeView === item.id
