        ...
        {step === 'select' ? (
          ...
          >
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                className="flex-1 py-3 rounded-lg bg-gradient-to-r from-raudhah-teal to-teal-500 text-black font-semibold hover:shadow-lg hover:shadow-teal-500/30 transition-all"
              >
                Tanya Ustaz AI
              </button>
            </div>
