...
const DailyHikmah: React.FC = () => {
    return (
        ...
        >
            <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/20 rounded-full blur-3xl animate-pulse z-0"></div>
            ...
            <div className="relative z-10 p-6 flex flex-col h-full justify-between">
                <div>
                    <div className="flex items-center gap-2 mb-4">
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_#a855f7]"></span>
                        <p className="text-[10px] font-black uppercase tracking-[0.25em] text-emerald-200">Daily Hikmah</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-slate-100 font-medium leading-relaxed italic border-l-2 border-emerald-500/40 pl-4">
                ...
                <div className="flex justify-between items-center mt-4 pt-4 border-t border-white/10">
                    ...
                    <motion.button
                        whileTap={{ scale: 0.9 }}
                        className="w-9 h-9 rounded-xl bg-emerald-500/20 flex items-center justify-center text-emerald-300 hover:bg-emerald-500 hover:text-white transition-all border border-emerald-500/20 backdrop-blur-md"
                    >
