        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
            <div className="bg-gradient-to-r from-slate-900 to-black border border-white/10 rounded-3xl p-8 sm:p-12 flex flex-col md:flex-row items-center gap-10 shadow-2xl">
                <div className="flex-1 text-center md:text-left">
                    <h2 className="text-3xl font-bold font-serif text-white mb-4">Partner with <span className="text-raudhah-teal">QuranPulse</span></h2>
                    ...
                    <TiltCard>
                        <div className="aspect-[4/5] bg-gradient-to-br from-raudhah-teal/20 to-purple-500/20 rounded-2xl border border-white/10 flex items-center justify-center relative overflow-hidden">
                            ...
                            <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-md p-3 rounded-lg border border-white/10">
                                <p className="text-xs text-raudhah-teal font-mono mb-1">GROWTH METRIC</p>
