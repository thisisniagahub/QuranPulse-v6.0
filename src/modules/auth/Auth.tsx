    ...
    <div className="theme-genesis min-h-screen flex flex-col items-center justify-center p-6 bg-islamic-dark relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl p-8 rounded-3xl border border-primary/30 shadow-[0_0_40px_rgba(0,191,165,0.15)] animate-fade-in relative z-10 transition-all duration-500">
        ...
        <div className="flex p-1 bg-slate-950/60 rounded-xl mb-6 border border-white/5 relative isolate">
          <div
            className={`absolute top-1 bottom-1 rounded-lg bg-primary shadow-lg shadow-primary/20 transition-all duration-300 ease-out -z-10 ${isLogin ? 'left-1 right-1/2 mr-0.5' : 'left-1/2 right-1 ml-0.5'
              }`}
          ></div>
          <button
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`relative w-full bg-black/60 border rounded-xl px-4 py-3 text-white outline-none placeholder:text-slate-600 transition-colors ${errors.name ? 'border-red-500' : 'border-slate-700 focus:border-primary/50'
                    }`}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`relative w-full bg-black/60 border rounded-xl px-4 py-3 text-white outline-none placeholder:text-slate-600 transition-colors ${errors.email ? 'border-red-500' : 'border-slate-700 focus:border-primary/50'
                  }`}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`relative w-full bg-black/60 border rounded-xl px-4 py-3 text-white outline-none placeholder:text-slate-600 transition-colors ${errors.password ? 'border-red-500' : 'border-slate-700 focus:border-primary/50'
                  }`}
                placeholder="••••••••"
