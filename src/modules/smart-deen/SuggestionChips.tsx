        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
            {suggestions.map((item, idx) => (
                <motion.button
                    ...
                    className="group relative p-3 rounded-xl bg-slate-800/50 border border-slate-700/50 hover:bg-teal-900/20 hover:border-raudhah-teal/20 text-left transition-all overflow-hidden"
                >
                    <div className="absolute inset-0 bg-gradient-to-r from-raudhah-teal/0 via-teal-500/5 to-teal-500/0 opacity-0 group-hover:opacity-100 transform -translate-x-full group-hover:animate-shimmer pointer-events-none"></div>
