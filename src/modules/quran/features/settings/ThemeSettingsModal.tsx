...
const THEMES: { id: ThemeType; name: string; icon: string; preview: { bg: string; text: string; accent: string } }[] = [
  ...
  },
  {
    ...
    name: 'Anmaat',
    icon: '✨',
    preview: { bg: 'bg-[#050b18]', text: 'text-white', accent: 'bg-[#00d2ff]' }
  },
  {
    id: 'safar',
    name: 'Safar',
    icon: '✈️',
    preview: { bg: 'bg-[#172554]', text: 'text-white', accent: 'bg-[#3b82f6]' }
  },
  {
    id: 'nabdh',
    name: 'Nabdh',
    icon: '⚡',
    preview: { bg: 'bg-[#0A1E42]', text: 'text-white', accent: 'bg-[#00BFFF]' }
  },
  {
    id: 'auto',
    name: 'Auto',
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <p className={`font-arabic text-xl ${font.id === 'tajweed' ? 'text-emerald-400' : 'text-white'
                              }`}>
                              {font.sample}
                            </p>
                            {currentFont === font.id && (
