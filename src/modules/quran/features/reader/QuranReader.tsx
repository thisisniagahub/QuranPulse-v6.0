...
const QuranReader: React.FC = () => {
    ...
    return (
        <div className="flex-1 flex flex-col overflow-hidden relative z-10 w-full h-full">
            ...
            {layoutMode === 'SCROLL' && (
                <div className={`flex-1 overflow-y-auto px-4 py-4 space-y-6 scrollbar-hide pb-24 transition-colors duration-1000 ${isZenMode
                    ? 'bg-black'
                    : theme === 'noor' || theme === 'light'
                        ? 'bg-[var(--bg-main)]' // Uses the variable we defined
