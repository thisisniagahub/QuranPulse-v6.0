                        ...
                        <div className="max-w-7xl mx-auto px-6 relative z-10">
                            ...
                            >
                                ...
                                <h2 className="text-4xl md:text-5xl font-[Poppins] font-bold text-white mb-6 tracking-tight">     
                                    Satu App, <span className="text-cyan-400">Pelbagai Dimensi</span>
                                </h2>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {FEATURES.map((feature, index) => (
                                    <motion.div
                                        ...
                                        className={`relative p-8 rounded-[2rem] bg-[#0c224b]/40 backdrop-blur-xl border border-white/10   
                                     hover:bg-[#0c224b]/60 transition-all duration-300 group overflow-hidden shadow-2xl    
