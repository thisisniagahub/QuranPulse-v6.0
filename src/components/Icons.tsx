...
export const IconPrevious = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const IconQuran = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/>
    <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>
    <path d="M12 6v4m0 4v.01"/>
  </svg>
);
...
export const IconMosque = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 3c-1.5 2-3 4-3 6 0 2.5 1.5 4.5 3 4.5s3-2 3-4.5c0-2-1.5-4-3-6z"/>
    <path d="M3 22v-7c0-2 1.5-3.5 3.5-3.5h11c2 0 3.5 1.5 3.5 3.5v7"/>
    <path d="M7 22v-4"/>
    <path d="M12 22v-4"/>
    <path d="M17 22v-4"/>
  </svg>
